...
import useGameState, { GameFeatures } from "@/hooks/useGameState"; // Import GameFeatures type
        ...
        <AnimatePresence mode="wait">
          ...
          {gameState.setupStep === 'features' && (
            <motion.div
              ...
              className="fade-in w-full"
            >
              {/* Corrected props passed to FeatureSelector */}
              <FeatureSelector 
                features={gameState.gameFeatures} 
                toggleFeature={gameState.toggleFeature} // Pass the correct toggle function
